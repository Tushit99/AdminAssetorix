        ...
        <form onSubmit={handleSubmitData}>
            ...
            <Box marginTop={12}>
                ...
                <Box display={"grid"}>
                    ...
                    {additionalPrice && <>
                        <Input type="text" w={"300px"} maxLength={"12"} value={expectedRental} onChange={(e) => setExpectedRental(NumericString(e.target.value))} placeholder="Expected rental" margin={"0"} />
